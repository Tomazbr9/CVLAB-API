...
public class LinkService {
    ...
    @Transactional
    public LinkResponseDTO updateLink(UUID profileId, UUID linkId, LinkUpdateDTO request, UUID userId){
    ...
    @Transactional
    public void deleteLink(UUID profileId, UUID linkId, UUID userId){
        Link link = linkRepository.findByIdAndProfileIdAndProfileUserId(linkId, profileId, userId).orElseThrow(() -> new RuntimeException("Acesso negado ou recurso não encontrado"));
